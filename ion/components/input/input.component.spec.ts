...
import { IonInputProps, InputType } from './types';
...
describe('IonInputComponent', () => {
  ...
  it.each(['text', 'password'] as InputType[])(
  ...
  it.each(['4', 4])(
    ...
    async (maxLength) => {
      ...
      await user.type(element, exampleText);
  ...
  describe('valueChange', () => {
    ...
    it('should change value when something is typed on input', async () => {
      await user.type(screen.getByTestId('input-element'), value);
